...
java.util.List<Model.Produto> lista = pc.buscarPorCategoria("BEBIDA");
for (Model.Produto p : lista) {
    if (p.getNome().equals("Suco de Laranja")) {
...
java.util.List<Model.Produto> lista = pc.buscarPorCategoria("BEBIDA");
for (Model.Produto p : lista) {
    if (p.getNome().equals("Refrigerante (Coca)")) {
        Model.SessaoPedido.getPedido().adicionarItem(p);
        break;
    }
}
